...
const Telegraf = (props: SVGProps<SVGSVGElement>) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        xmlnsXlink="http://www.w3.org/1999/xlink"
        viewBox="-250 -250 500 500"
        {...props}
        className={cn("text-black dark:text-white", props.className)}
    >
        <defs>
        ...
        <polygon stroke="#e74625" strokeWidth="12" fillOpacity="0" points="0,-200 173.2,-100 173.2,100 0,200 -173.2,100 -173.2,-100" />
